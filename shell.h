...
char *mb_getline(void);
char *mb_strtok(char *str, const char *delim);
char *mb_non_interactive_getline(void);
char *mb_getenv(char *enviro);
int _putchar(char c);
...
int mb_strncmp(char *str1, char *str2, int num);
